...
export const metadata = {
  title: "التخصصات المناسبة لمعدلك",
  description:
    "اختر شعبة الباكالوريا وأدخل معدلك لتتعرف على الكليات والتخصصات الأقرب إليك اعتماداً على آخر معدلات التوجيه المسجلة.",
  alternates: {
    canonical: "/orientation/match",
  },
  openGraph: {
    title: "التخصصات المناسبة لمعدلك | MauriResults",
    description: "اعرف الكليات والتخصصات الأقرب إلى شعبة الباك ومعدلك.",
    url: "/orientation/match",
    type: "website",
  },
};
...
export default function OrientationMatchPage() {
  return (
