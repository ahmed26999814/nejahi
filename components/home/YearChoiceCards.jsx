        ...
        return (
          ...
          >
            ...
            <span className="relative z-10 grid h-full grid-cols-[1fr_auto] items-start gap-3">
              ...
              <span className={`rounded-full px-2 py-1 text-[9px] font-black shadow-sm md:px-3 md:text-[11px] ${available ? "bg-white text-emerald-700" : "bg-amber-100 text-amber-800"}`}>
                {available ? "فتح" : "قريبًا"}
              </span>
            </span>
          </a>
        );
