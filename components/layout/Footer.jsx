  ...
  return (
    <footer id="developer" className="app-shell py-6 md:py-10">
      <section className="premium-footer">
        ...
        <div className="grid gap-6 lg:grid-cols-[1.1fr_.8fr_.9fr]">
          ...
          <div>
            <h3 className="text-sm font-black text-slate-950 dark:text-white">عن المشروع</h3>
            <p className="mt-3 text-sm font-bold leading-7 text-slate-500 dark:text-slate-300">نظام تصميم موحد، كروت زجاجية، إحصائيات تفاعلية، وتجربة متجاوبة.</p>
            <button className="developer-button mt-4" onClick={() => setDeveloperOpen(true)} type="button">
              <CodeIcon />
